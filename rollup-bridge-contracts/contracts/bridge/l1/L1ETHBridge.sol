  ...
  IL1ETHBridge
{
  ...
  function depositETH(
    ...
    _deposit(to, amount, l2FeeRefundRecipient, new bytes(0), gasLimit);
  }
  ...
  function depositETHAndCall(
    ...
    _deposit(to, amount, l2FeeRefundRecipient, data, gasLimit);
  }
  ...
  function _deposit(
    ...
    bytes memory _message = abi.encodeCall(
      ...
      (l2EthAddress, _from, _to, _l2FeeRefundRecipient, _amount, _data)
    );
