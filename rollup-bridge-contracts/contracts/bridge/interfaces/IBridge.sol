...
interface IBridge {
  ...
  /// @notice The address of Bridge contract on other side (for L1Bridge it would be the bridge-address on L2 and for L2Bridge this would be the bridge-address on L1)
