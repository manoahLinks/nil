...
interface IL1BridgeMessenger is IBridgeMessenger {
    ...
    struct DepositMessage {
        ...
        uint256 nonce;
        /// @notice The nonce of the deposit message.
        uint256 gasLimit;
        /// @notice The gas limit for processing the message.
        uint256 expiryTime;
        /// @notice The expiry time of the deposit message.
        bytes message;
        /// @notice The encoded message data.
        bool isCancelled;
        /// @notice Whether the deposit message is cancelled.
        DepositType depositType;
    }
    /// @notice The type of the deposit.
